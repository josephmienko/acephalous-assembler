...
# Set BUILD_VARIANT to debian
add_config_var "BUILD_VARIANT" "debian"
add_config_var "DEBIAN_SUITE" "bookworm"
add_config_var "LIVE_INSTALLER_HOSTNAME" "debian-installer"
add_config_var "LIVE_INSTALLER_USER" "root"
